...
//Declare the character array for each horse
...
void print_Track (char horseArr[], int position, char num); // A function to print the track of each horse
int coin_flip (); // A function to determine whether the horse will move forward or remain in its original position
int start_race (); // A function to start the race and make changes in the horses' position
